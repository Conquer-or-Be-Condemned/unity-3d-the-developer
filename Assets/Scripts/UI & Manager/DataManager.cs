...
public class DataManager : MonoBehaviour
{
    ...
    private static readonly int[] MarginList = { 75, 1, 4, 40, 500, 40 };
    
    private static readonly int[] CostList = { 35, 50, 65, 0, 0 };
    ...
    //  NOTE : Please keeping Serialization
